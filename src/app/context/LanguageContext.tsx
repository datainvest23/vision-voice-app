...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    freeValuationAvailable: 'You have 1 free valuation available today.',
    freeValuationUsed: 'You have used your free valuation for today.',
    nextFreeValuation: 'Next free valuation available at',
    tokenBalance: 'Token Balance',
    upgradeToDetailed: 'Upgrade to Detailed Valuation for',
    detailedDescription: 'Detailed valuations include additional research, comparative sales data, and more in-depth condition analysis.',
    usingFreeValuation: 'Using your free daily valuation.',
    usingToken: 'Using 1 token from your account.',
    needToPayOrPurchase: 'You need to purchase tokens or pay for this valuation.',
    cancel: 'Cancel',
    processing: 'Processing...',
    buyTokens: 'Buy Tokens',
    buyTokensDescription: 'Purchase tokens to create additional valuations beyond your free daily limit.',
    tokenPackage5: '5 Tokens',
    tokenPackage10: '10 Tokens',
    priceTokens5: '$5.00',
    priceTokens10: '$9.00',
    bestValue: 'Best Value',
    purchase: 'Purchase',
    valuationsHeading: 'My Valuations',
    noValuationsYet: 'You haven\'t created any valuations yet.',
    createFirstValuation: 'Create your first valuation',
    standard: 'Standard',
    detailed: 'Detailed',
